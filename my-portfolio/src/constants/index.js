...
const experiences = [
    ...
    {
        title: "Full-Stack Developer",
        company_name: "Kim Bowen Portfolio",
        iconBg: "#383E56",
        date: "Mar 2026 - July 2026",
        points: [
            "Designed and developed a production portfolio platform for a veteran animation professional with 30+ years of industry work.",
            "Built a responsive React frontend with custom project galleries, folder-style showcase cards, fullscreen artwork viewing, and mobile optimization.",
            "Developed a custom admin dashboard for managing shows, uploading artwork, deleting images, renaming projects, and controlling display order.",
            "Integrated Supabase PostgreSQL, Authentication, and Storage with Row Level Security to support secure content management and public gallery access.",
            "Deployed the application on Vercel, configured environment variables, connected the production domain, and migrated DNS routing from Hostinger.",
        ],
    },
